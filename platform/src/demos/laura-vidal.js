export default {
  ...
  contact: {
    ...
    widget: {
      ...
      colorAcento: '#aa3bff',
      colorBorde: '#e5e4e7',
      tituloFormulario: 'Haz tu consulta',
      textoBtnReservar: 'Enviar',
      ...
      cierreTemporalFecha: '',
      servicios: [],
      preguntasExtra: [{ id: 'p1779803012800', label: 'Mensaje:', tipo: 'texto', campoTipo: 'textarea', opciones: [], requerida: true, guardado: true }],
      ...
      camposActivos: { nombre: true, apellidos: false, telefono: true, email: true, personas: false, fecha: false, hora: false, mensaje: false },
